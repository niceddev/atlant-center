                    ...
                    <tbody>
                        @foreach($directions as $direction)
                            <tr class="max-h-7 grid-cols-4 bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="py-4 px-6">
                                    <a href="{{ route('platform.directions.edit', $direction->id) }}" class="hover:bg-gray-300 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                                        {{ __('common.edit') }}
                                    </a>
                                </td>
                            </tr>
